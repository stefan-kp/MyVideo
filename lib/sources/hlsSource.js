...
class HlsSource extends Channel {
  ...
  // Backwards-compat for callers that still read channel.url. Tasks 4-5 will migrate
  // those callers to use resolveStream() and this getter can be removed.
  get url() { return this.upstreamUrl; }
