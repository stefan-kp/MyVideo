...
// Lazy-require HlsSource inside loadChannels() to avoid a circular dependency
// (hlsSource -> hlsProxy -> channels -> hlsSource).
...
function loadChannels() {
  ...
  if (typeof HlsSource !== 'function') {
    // Mid-load circular require (hlsSource -> hlsProxy -> channels). Defer:
    // the first public-API call will retry once hlsSource finishes loading.
    return;
  }
...
// Assign exports BEFORE the initial loadChannels() so that any module pulled in
// by the HlsSource require chain (notably hlsProxy, which requires channels)
// captures a reference to this populated exports object rather than an empty
// placeholder.
module.exports.findChannel = findChannel;
module.exports.findChannelById = findChannelById;
module.exports.listChannels = listChannels;
module.exports.loadChannels = loadChannels;
module.exports.getLogoUrl = getLogoUrl;
module.exports.getLogoUrlForChannel = getLogoUrlForChannel;
